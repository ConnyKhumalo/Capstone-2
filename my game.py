#Create your own Game,your programe should include:
#One 'player' object and should be able to move the player around the screen by  using up,down,left and right arrows.
#Have at least 3 'enemy' objects,the enemies should all move across the screen from different positions.
import pygame
import random 
